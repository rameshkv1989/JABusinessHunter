		...
		<div class="main-container-inner">
			...
			<div class="breadcrumbs">
				<div class="inner">
					<ul>
						...
						<li class="category348"><strong>Franchise</strong></li>
					</ul>
				</div>
				<!--inner-->
			</div>
			...
			<article class="col-main">
				...
				<div class="page-title">
					<h2>Franchise - Ads Subscription</h2>
				</div>
				<!--page-title-->



				<div id="franchisePackagePic" class="category-description std">
				...
				<div class="category-products">
					...
					<form:form id="contactForm" method="post" commandName="franchiseModel" action="franchiseSubmit.do">
						...
						<div id="franchise2NewDiv" style="display: none">
							<jsp:include page="franchise_page2.jsp"></jsp:include>
						</div>
						<!--column sixty-->
