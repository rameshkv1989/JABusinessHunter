...
<div class="category-products"><br/>
 ...
 <option value="select">--- Select ---</option> 
  ...
  <li>
                    <label for="companyregdno">Company Registration No.   </label>
					<div class="input-box">
		    ...
		    <li>
                  ...
                  <div class="input-box">
				    <input name="Contact_Title" id="Contact_Title" title="Contact_Title" value="" class="input-text required-entry" type="text" />
					   </div>
		   </li>   
		     <li>
			...
			<li>
				...
				<li>
                    <label for="contactwebsite">Contact Website<em class="required">*</em></label>
					<div class="input-box">
                    <input name="contactwebsite" id="contactwebsite" title="contactwebsite" value="" class="input-text required-entry" type="text" />
					</div>
            </li>
			<li>
                    <label for="email">Email Address<em class="required">*</em></label>
					<div class="input-box">
                    <input name="email" id="email" title="email" value="" class="input-text required-entry" type="text" />
					</div>
            </li>
 ...
 <ul class="form-list">
   ...
   <label for="whythisbusiness">Why this business is worth investing? (2000 char)<em class="required">*</em></label>
              <textarea name="whythisbusiness" id="whythisbusiness" title="whythisbusiness" class="required-entry" cols="5" rows="10"></textarea>
