...
<div class="page-title">
        <h2>Service Provider - Ads Posting</h2>
</div> <!--page-title-->
...
<div class="category-products"><br/>
  ...
  <div class="column thirty">
        ...
        <ul class="form-list">
            <li>
					...
					<div class="input-box">
                    <input name="heading" id="heading" title="heading" value="" class="input-text required-entry" type="text" />
					</div>
            </li>
			
			 <li>
                    <label for="servicetype">Type Of Service<em class="required">*</em></label>
            
                  <div class="input-box">
				  <select name="servicetype" id="servicetype" title="servicetype" class="required-entry input-text">
 <option value="select">--- Select ---</option>  
  ...
  <li>
                    <label for="companyfullname ">Company Full Name  <em class="required">*</em></label>
					<div class="input-box">
  ...
  <li>
                    <label for="companyregdno">Company Registration No.  <em class="required">*</em> </label>
					<div class="input-box">
		   ...
		   <li>
                    <label for="companywebsite">Company Website<em class="required">*</em></label>
					<div class="input-box">
                    <input name="companywebsite" id="companywebsite" title="companywebsite" value="" class="input-text required-entry" type="text" />
					</div>
            </li>
			<li>
                    <label for="companyaddress">Company Address<em class="required">*</em></label>
					<div class="input-box">
                    <input name="companyaddress" id="companyaddress" title="companyaddress" value="" class="input-text required-entry" type="text" />
					</div>
            </li>
 ...
 <option value="select">--- Select ---</option> 
		    ...
		    <li>
                   ...
                   <div class="input-box">
				  <select name="Contact_Title" id="Contact_Title" title="Contact_Title" class="required-entry input-text">
 <option value="select">--- Select ---</option> 
 ...
 <option value="Dr">Dr</option>
		     ...
		     <li>
					...
					<div class="input-box">
                    <input name="contactname" id="contactname" title="contactname" value="" class="input-text required-entry" type="text" />
					</div>
            </li>
			<li>
                    <label for="contactno">Contact Mobile No.<em class="required">*</em></label>
					<div class="input-box">
                    <input name="contactno" id="contactno" title="contactno" value="" class="input-text required-entry" type="text" />
					</div>
            </li>
			<li>
 ...
 <div class="column thirty last">
  <label for="companyprofile">Company Profile (2000 characters)<em class="required">*</em></label>
              <textarea name="companyprofile" id="companyprofile" title="companyprofile" class="required-entry" cols="5" rows="10"></textarea>
 ...
 <ul class="form-list">
   ...
   <label for="howarewedifferent">How are we different from the other service providers?(2000 char)<em class="required">*</em></label>
              <textarea name="howarewedifferent" id="howarewedifferent" title="howarewedifferent" class="required-entry" cols="5" rows="10"></textarea>
  

   <input type="text" name="hideit" id="hideit" value="" style="display:none !important;" />                  
   <button type="submit" title="Payment" class="button btn-sent"><span> Payment </span></button>
