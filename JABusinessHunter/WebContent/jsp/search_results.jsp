		...
		<div class="main-container-inner">
			...
			<div class="breadcrumbs">
				<div class="inner">
					<ul>
						...
						<li class="category348"><strong>Search Results</strong></li>
					</ul>
				</div>
				<!--inner-->
			</div>
			...
			<article class="col-main">
				...
				<div class="category-products">
					<form method="post" id="readMoreForm">
						<ol class="products-list" id="products-list">
							<li class="item first odd">

								<div class="product-image">
									<a href="#" title=" " class=""> <img src="images/bus2.jpg"
										class="small-image" alt=" ">
									</a>
								</div>
								<div class="product-shop">
									<h2 class="product-name">
										<a href="# title=" BusinessHeading">Business Heading 1</a>
									</h2>
									<div class="price-box">
										<span class="regular-price" id="product-price-62"> <span
											class="price">Contact Person Name : XXXXXXXXXXX,
												Mobile Number : XXXXXXXXXX</span>
										</span>
									</div>


									<div class="desc std">
										<p>Business Profile short description. Business Profile
											short description.Business Profile short description.Business
											Profile short description.Business Profile short
											description.Business Profile short description. Business
											Profile short description. Business Profile short
											description.Business Profile short description.Business
											Profile short description.Business Profile short
											description.Business Profile short description. Business
											...
											description.Business Profile short description.Business
											Profile short description.Business Profile short
											description.Business Profile short description.</p>
									</div>

									<!-- BEGIN ACTIONS -->
									<div class="actions">
										<button type="button" title="View In Detail"
											class="button btn-cart ajx-cart"
											onclick="setLocation('http://demo.magikthemes.com/index.php/accordfixred/checkout/cart/add/uenc/aHR0cDovL2RlbW8ubWFnaWt0aGVtZXMuY29tL2luZGV4LnBocC9hY2NvcmRmaXhyZWQvYm95cy5odG1sP21vZGU9bGlzdA,,/product/62/form_key/8nwGp5d4DW0C83ts/')">
							...
							<li class="item first odd">
								<div class="product-image">
									<a href="#" title=" " class=""> <img src="images/bus1.jpg"
										class="small-image" alt=" ">
									</a>
								</div>
								<div class="product-shop">
									<h2 class="product-name">
										<a href="# title=" BusinessHeading">Business Heading 2</a>
									</h2>
							...
							<li class="item first last even">
								...
								<div class="product-shop">
									<h2 class="product-name">
										<a href="# title=" BusinessHeading">Business Heading 3</a>
									</h2>
