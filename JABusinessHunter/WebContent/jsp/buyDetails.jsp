...
<body class="flexible  cms-index-index cms-accord-home" onload="tabCssChange('buy-details');">
            <noscript> 
...
<div class="category-products">
    <form method="post" id="buyDetailsForm">
...
function setLocation(a,b,c) { 
	document.getElementById('buyDetailsForm').action="readMore.do";
	document.getElementById('buyDetailsForm').submit();
