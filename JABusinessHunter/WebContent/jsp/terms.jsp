	...
	<section class="main-container col2-left-layout">
		<div class="main-container-inner">
			...
			<div class="breadcrumbs">
				<div class="inner">
					<ul>
						...
						<li class="category348"><strong>Terms & Conditions</strong></li>
					</ul>
				</div>
				<!--inner-->
			</div>
			...
			<article class="col-main">
				...
				<div class="category-products" style="width: 100%; height: 650px">
					<br />
					<embed height="100%" width="100%" src="./documents/Terms.pdf" type='application/pdf'>
				</div>
