...
<div class="category-products"><br/>
 ...
 <option value="Non_Franchise">Non Franchise</option>  
		    ...
		    <li>
                  ...
                  <div class="input-box">
				  <select name="companytype" id="companytype" title="companytype" class="required-entry input-text">
 <option value="select">--- Select ---</option> 
 ...
 <div class="column thirty last">
  <label for="companyprofile">Company Profile (2000 characters)<em class="required">*</em></label>
              <textarea name="companyprofile" id="companyprofile" title="companyprofile" class="required-entry" cols="5" rows="17"></textarea>
 ...
 <ul class="form-list">
   ...
   <label for="whythisbusiness">Why this business is worth investing? (2000 char)<em class="required">*</em></label>
              <textarea name="whythisbusiness" id="whythisbusiness" title="whythisbusiness" class="required-entry" cols="5" rows="17"></textarea>
  

  <label for="sellingreason">Reason for Selling the Business (300 characters)<em class="required">*</em></label>
              <textarea name="sellingreason" id="sellingreason" title="sellingreason" class="required-entry" cols="2" rows="5"></textarea>
