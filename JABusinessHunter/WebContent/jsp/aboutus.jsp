...
<body class="flexible  cms-index-index cms-accord-home" onload="tabCssChange('nav-aboutus');">
            <noscript>
    ...
    <div class="category-description std">
        ...
        <div id="slides">
          <div class="slides_container">
            <div><img title="About Us" src="images/about.jpg" alt="J & A Business Hunter About Us" /> 
...
<br />
<p>
A detailed analysis about this business has been done since Year 2015 and we found out that there are not many websites that are offering similar business' concept that we are doing now i.e. online business brokering, especially in Malaysia.  We have included some new and exclusive features that helps our business portal looks more useful and comprehensive.
